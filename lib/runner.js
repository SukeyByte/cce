...
export async function runClaude(config, args) {
  ...
  // Remove ANTHROPIC_AUTH_TOKEN to avoid auth conflict with third-party providers
  ...
  // Neutralize ANTHROPIC_AUTH_TOKEN from settings.json to avoid auth conflict
  settingsOverride.env.ANTHROPIC_AUTH_TOKEN = ''
